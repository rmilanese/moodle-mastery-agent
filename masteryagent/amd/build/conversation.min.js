    ...
    const init = selector => {
        ...
        root.addEventListener('submit', async (event) => {
            ...
            try {
                ...
                const historyState = new Map(Array.from(content.querySelectorAll(expandableSections), node => [sectionKey(node), node.open]));
                const browsing = document.activeElement;
                const keepExternalFocus = preserveExternalFocus();
                const preserveFocus = content.contains(browsing) && browsing.closest('[data-region="lesson-history"], [data-region="conversation-navigation"], '
